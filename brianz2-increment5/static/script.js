/* MonoMuse — Main Script (Increment 5)
   Libraries: jQuery 4.0.0 (index.html), Leaflet 1.9.x (explore.html) */
...
function initCheckout() {
  ...
  function updateTotal() {
    ...
    if (totalAmt) {
      totalAmt.textContent = '$' + (qty * PRICE).toFixed(2);
    }
  }
  ...
  form.addEventListener('submit', function(e) {
    ...
    var finalTotal = (finalQty * PRICE).toFixed(2);
